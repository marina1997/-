...
namespace Shor_al
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            numberToFactor = Int32.Parse(Console.ReadLine());

            Shor shor = new Shor(new Random());

            //int [] a=new int [2];
            //a=shor.Run(numberToFactor);
           // Console.WriteLine(a);
            Console.WriteLine("Множители числа " + numberToFactor + ": " + string.Join(", ", shor.Run(numberToFactor)) + ".");
            Console.ReadLine();
        }
    }
